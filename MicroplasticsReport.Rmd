...
ft <- flextable(plastic_count) |>
  set_caption(caption = "Table 1.Plastic particle count by sample name", 
...
The MIPPR laboratory tracks the accuracy and precision of the analytical method through Laboratory Fortified Blanks (LFBs). An LFB is a sample of MAG water spiked with a known type and quantity of plastic material. LFBs were spiked with polyamide 66 (sized >500 µm), cellulose acetate (sizes 212-500 µm), and red beads (polyolefins sized 75-90 µm). The recoveries of the spiked polymers were `r pa66`, `r cellu`, and `r poly`%, respectively (Table 3B). These recoveries are `r acceptable` of 50% -150%, as defined by the method. One of these recoveries, the `r recover`, is not within the acceptable range of 50% -150%, as defined by the method.
